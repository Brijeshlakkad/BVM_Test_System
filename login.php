	...
	<div class="row">
		...
		<table class="myTable">
			<div class="form-group">
				<tr>
				  <td><label for="l_type">Login Type</label></td>
				  <td><select class="form-control" name="l_type" ng-model="l_type">
						<option value="f_">Faculty</option>
						<option value="student_">Student</option>
					</select>
					</td>
				  <td></td>
				</tr>
			...
			<tr>
				...
				<td><input type="submit" class="btn btn-primary" ng-click="login_status()" ng-disabled="myForm.l_email.$invalid || myForm.l_password.$invalid || myForm.l_type.$invalid"></td>
				<td></td>
				<td></td>
					...
					$scope.login_status =function()
									{
										$http({
													method : "POST",
													url : "login_data.php",
													data: "l_type="+$scope.l_type+"&l_email="+$scope.l_email+"&l_password="+$scope.l_password,
